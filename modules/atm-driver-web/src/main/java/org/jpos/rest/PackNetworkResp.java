...
@Path("/packNetworkResp")
public class PackNetworkResp {

    @GET
    @Produces({MediaType.APPLICATION_JSON})
    @Consumes(MediaType.TEXT_PLAIN)
    @Path("/mti/{mti}/f7/{f7}/f11/{f11}/f12/{f12}/f13/{f13}/f39/{f39}/f70/{f70}")
    ...
    public Response echoGet(
        ...
        try {
            ...
            try {
                ...
                isoMsg.set(39, f39 ); isoMsg.set(70, f70 );
