...
@Path("/packNetworkPath")
public class PackNetworkPath {

    @GET
    @Produces({MediaType.APPLICATION_JSON})
    @Consumes(MediaType.TEXT_PLAIN)
    @Path("/mti/{mti}/f7/{f7}/f11/{f11}/f12/{f12}/f13/{f13}/f39/{f39}/f41/{f41}/f70/{f70}")
    ...
    public Response echoGet(
            ...
            @PathParam("f7") String f7,
            @PathParam("f11") String f11, @PathParam("f12") String f12, @PathParam("f13") String f13, @PathParam("f39") String f39,
            @PathParam("f41") String f41,@PathParam("f70") String f70,
        ...
        PackNetworkResp iso = new PackNetworkResp();
        String message = null;
        try {
            ...
            try {
                ...
                isoMsg.setMTI(mti);
                //set all the fields
                isoMsg.set(7, f7 ); isoMsg.set(11, f11 ); isoMsg.set(12, f12 ); isoMsg.set(13, f13 );
                isoMsg.set(39, f39 ); isoMsg.set(41, f41 ); isoMsg.set(70, f70 );
