...
@Path("/packIsoBalanceEnquiry")
public class PackISOBalanceEnquiry {

    @GET
    @Produces({MediaType.APPLICATION_JSON})
    @Consumes(MediaType.TEXT_PLAIN)
    @Path("/mti/{mti}/f2/{f2}/f3/{f3}/f4/{f4}/f7/{f7}/f11/{f11}/f12/{f12}/f13/{f13}/f15/{f15}/f18/{f18}/f25/{f25}/f28/{f28}/f30/{f30}/f32/{f32}/f35/{f35}/f37/{f37}/f39/{f39}/f41/{f41}/f42/{f42}/f43/{f43}/f49/{f49}/f54/{f54}/f56/{f56}/f59/{f59}/f102/{f102}/f123/{f123}/f127/{f127}")
    ...
    public Response echoGet(
            ...
            @PathParam("f32") String f32, @PathParam("f35") String f35, @PathParam("f37") String f37,
        ...
        PackISOBalanceEnquiry iso = new PackISOBalanceEnquiry();
        String message = null;
        try {
            ...
            try {
                ...
                isoMsg.set(32, f32 ); isoMsg.set(35, f35 ); isoMsg.set(37, f37 );
