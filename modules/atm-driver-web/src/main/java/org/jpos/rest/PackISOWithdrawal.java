...
@Path("/packIsoWithdrawal")
public class PackISOWithdrawal {

    @GET
    @Produces({MediaType.APPLICATION_JSON})
    @Consumes(MediaType.TEXT_PLAIN)
    @Path("/mti/{mti}/f2/{f2}/f3/{f3}/f4/{f4}/f7/{f7}/f11/{f11}/f12/{f12}/f13/{f13}/f15/{f15}/f18/{f18}/f25/{f25}/f28/{f28}/f30/{f30}/f32/{f32}/f35/{f35}/f37/{f37}/f38/{f38}/f39/{f39}/f41/{f41}/f42/{f42}/f43/{f43}/f49/{f49}/f54/{f54}/f56/{f56}/f59/{f59}/f102/{f102}/f123/{f123}/f127/{f127}")
    ...
    public Response echoGet(
            ...
            @PathParam("f2") String f2, @PathParam("f3") String f3, @PathParam("f4") String f4, @PathParam("f7") String f7,
            @PathParam("f11") String f11, @PathParam("f12") String f12, @PathParam("f13") String f13, @PathParam("f15") String f15,
            @PathParam("f18") String f18, @PathParam("f25") String f25, @PathParam("f28") String f28, @PathParam("f30") String f30,
            @PathParam("f32") String f32, @PathParam("f35") String f35, @PathParam("f37") String f37, @PathParam("f38") String f38,
            @PathParam("f39") String f39, @PathParam("f41") String f41, @PathParam("f42") String f42, @PathParam("f43") String f43,
            @PathParam("f49") String f49, @PathParam("f54") String f54, @PathParam("f56") String f56, @PathParam("f59") String f59,
            @PathParam("f102") String f102, @PathParam("f123") String f123, @PathParam("f127") String f127,
        ...
        PackISOWithdrawal iso = new PackISOWithdrawal();
        String message = null;
        try {
            ...
            try {
                ...
                isoMsg.setMTI(mti);
                //set all the fields
                isoMsg.set(2, f2 ); isoMsg.set(3, f3 ); isoMsg.set(4, f4 ); isoMsg.set(7, f7 );
                isoMsg.set(11, f11 ); isoMsg.set(12, f12 ); isoMsg.set(13, f13 ); isoMsg.set(15, f15 );
                isoMsg.set(18, f18 ); isoMsg.set(25, f25 ); isoMsg.set(28, f28 ); isoMsg.set(30, f30 );
                isoMsg.set(32, f32 ); isoMsg.set(35, f35 ); isoMsg.set(37, f37 ); isoMsg.set(38, f38 );
                isoMsg.set(39, f39 ); isoMsg.set(41, f41 ); isoMsg.set(42, f42 ); isoMsg.set(43, f43 );
                isoMsg.set(49, f49 ); isoMsg.set(54, f54 ); isoMsg.set(56, f56 ); isoMsg.set(59, f59 );
                isoMsg.set(102, f102 ); isoMsg.set(123, f123 ); isoMsg.set(127, f127 );
