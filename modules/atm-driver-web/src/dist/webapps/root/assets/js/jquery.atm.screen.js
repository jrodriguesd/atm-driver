...
$(document).ready(function()
{
	var util = 
	{
		...
		getActivePositionFromClassGroup: function(el)
		{
			...
			console.log("JFRD Line 48 " + classes);
	...
	var nav = {
		...
		nextPrevNav: function(e, override) {
			...
			switch(struck) {
				...
				case 40:
			        ...
			        console.log("JFRD Line 145 >" + position + "<");
					$('#' + position).select();
					break;
		...
		updateByEntry: function(e, next) 
		{
			...
			if (e.keyCode == null)
			{
			    console.log("JFRD Line 193 " + e.keyCode);
				// e.keyCode = 39;
			}
	...
	*/
	...
	$("#atm-screen").delegate('input', 'keyup', function(e){
		...
		console.log("JFRD Line 408 " + e.keyCode);
    ...
    $.ajax(
    {
        // url: 'http://localhost/app/functions/get_screens_data.php',
        // url: '../app/functions/get_screens_data.php',
		url: 'functions/get_screens_data.jsp',
        method: "GET",
    ...
    {
		var scr = screens[  $("#screenList :selected").attr('value') ];
