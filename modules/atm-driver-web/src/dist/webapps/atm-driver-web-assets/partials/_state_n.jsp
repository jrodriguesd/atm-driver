                                            ...
                                            <div role="tabpanel" class="tab-pane <%= request.getParameter("tabClass") %>" id="nav-<%= request.getParameter("tabIndex") %>">
                                                ...
                                                <form id="statesForm-<%= request.getParameter("tabIndex") %>" action="javascript:alert( 'success!' );">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label id="sta_1_title-<%= request.getParameter("tabIndex") %>">Screen Number</label>
                                                                <div class="input-group">
                                                                    <span class="input-group-text">
                                                                        <i class="fa fa-edit fa-fw"></i>
                                                                    </span>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label id="sta_2_title-<%= request.getParameter("tabIndex") %>">Good Read Next State</label>
                                                                <div class="input-group">
                                                                    <span class="input-group-text">
                                                                        <i class="fa fa-edit fa-fw"></i>
                                                                    </span>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label id="sta_3_title-<%= request.getParameter("tabIndex") %>">Error Screen Number</label>
                                                                <div class="input-group">
                                                                    <span class="input-group-text">
                                                                        <i class="fa fa-edit fa-fw"></i>
                                                                    </span>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label id="sta_4_title-<%= request.getParameter("tabIndex") %>">Read Condition 1</label>
                                                                <div class="input-group">
                                                                    <span class="input-group-text">
                                                                        <i class="fa fa-edit fa-fw"></i>
                                                                    </span>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label id="sta_5_title-<%= request.getParameter("tabIndex") %>">Read Condition 2</label>
                                                                <div class="input-group">
                                                                    <span class="input-group-text">
                                                                        <i class="fa fa-edit fa-fw"></i>
                                                                    </span>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label id="sta_6_title-<%= request.getParameter("tabIndex") %>">Read Condition 3</label>
                                                                <div class="input-group">
                                                                    <span class="input-group-text">
                                                                        <i class="fa fa-edit fa-fw"></i>
                                                                    </span>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label id="sta_7_title-<%= request.getParameter("tabIndex") %>">Card Return Flag</label>
                                                                <div class="input-group">
                                                                    <span class="input-group-text">
                                                                        <i class="fa fa-edit fa-fw"></i>
                                                                    </span>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label id="sta_8_title-<%= request.getParameter("tabIndex") %>">No FIT Match Next State</label>
                                                                <div class="input-group">
                                                                    <span class="input-group-text">
                                                                        <i class="fa fa-edit fa-fw"></i>
                                                                    </span>
