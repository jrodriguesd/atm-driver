                            ...
                            <div class="col-12" style="border: 0px solid black;">
                                <div class="col-sm-12">
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link btn btn-outline-secondary" style="color: rgb(33, 37, 41); outline: none; box-shadow: none;" data-toggle="tab" id="nav-4-tab" href="#nav-4">ATM Confirmation</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link btn btn-outline-secondary" style="color: rgb(33, 37, 41); outline: none; box-shadow: none;" data-toggle="tab" id="nav-5-tab" href="#nav-5">ATM Confirmation ISO request</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link btn btn-outline-secondary" style="color: rgb(33, 37, 41); outline: none; box-shadow: none;" data-toggle="tab" id="nav-6-tab" href="#nav-6">ATM Confirmation ISO reply</a>
                                        </li>
                                    </ul>
